...
const float collision_radius = 0.7; //The radius in which search collision should be a little be higher than the dimension of the robot
...
{   
        ...
        RRT(Eigen::Vector4d state_): parent(NULL), state(state_){}
